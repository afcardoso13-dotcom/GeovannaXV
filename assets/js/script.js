...
const startJewel = document.getElementById("startJewel");
...
async function iniciarVideo(){
    ...
    try{
        ...
        if(startJewel){
            startJewel.classList.add("hidden");
        }
...
if(startJewel){
    ...
    startJewel.addEventListener("click", iniciarVideo);

    startJewel.addEventListener("keydown", (event) => {
        ...
        text:`
            <div class="grande-dia">
                ...
                <div class="evento-data">
                    ...
                    <span class="evento-mes">DEZEMBRO</span>
                    <span class="evento-ano">2026</span>
                </div>
...
function atualizarPlayer() {
    ...
    const startJewelEl = document.getElementById("startJewel");
    ...
    // A joia fica centralizada dentro da área real do vídeo,
    // preservando o tamanho pequeno do ponto de entrada.
    if (startJewelEl) {

        startJewelEl.style.left = (left + realWidth / 1.98) + "px";
        startJewelEl.style.top = (top + realHeight * 0.578) + "px";
